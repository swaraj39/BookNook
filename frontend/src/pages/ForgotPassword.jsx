                    ...
                    <>
                        ...
                        <form onSubmit={handleOtpSubmit} className="form-grid">
                            <div className="field full">
                                <span style={{ marginBottom: 8 }}>One-time code</span>
                                <div className="otp-boxes-container">
                                    {Array.from({ length: 6 }).map((_, index) => (
                                        <input
                                            ...
                                            pattern="\d*"
                                            maxLength={1}
                                            className="input otp-box-input"
                                            value={otp[index] || ""}
                                            autoFocus={index === 0}
                                            onChange={(e) => {
                                                const val = e.target.value.replace(/\D/g, "");
                                                if (!val) {
                                                    // Handle character deletion/clearing
                                            ...
                                            onKeyDown={(e) => {
                                                if (e.key === "Backspace") {
                                                    if (!otp[index] && index > 0) {
                                                        // If box is empty, clear previous box and focus it
                                                        const otpArray = otp.split("");
                                                        otpArray[index - 1] = "";
                                                        setOtp(otpArray.join(""));
                                            ...
                                            onPaste={(e) => {
                                                ...
                                                // Move focus to the last populated box or final box
                            ...
                            <button type="submit" className="btn primary full" disabled={loading || otp.length !== 6 || otpSecondsLeft === 0}>
